...
import Fade from "react-reveal/Fade"; // Add this import for Fade animation

function Home2() {
  return (
    <>
      <Box className="HomeMargin" sx={{ backgroundColor: 'rgba(237,249,254,255)', padding: '2rem' }}>
        <Fade top duration={2000}> {/* Add Fade animation here */}
          <Typography
            variant="h1"
            align="center"
            sx={{
